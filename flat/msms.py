...
# TEMPORARY
# exe = "C:\\Users\\jurec\\AppData\\Roaming\\Python\\Python310\\site-packages\\msms\\msms.exe"
# filename = "C:\\Users\\jurec\\AppData\\Roaming\\Python\\Python310\\site-packages\\msms\\atmtypenumbers"
...
def msms_surface(selection='polymer', state=1, density=3, name='',
    ...
    try:
        ...
        print("radius", _get_solvent_radius(selection, state, _self=_self))
